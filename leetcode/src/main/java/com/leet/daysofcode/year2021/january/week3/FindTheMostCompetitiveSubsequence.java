...
public class FindTheMostCompetitiveSubsequence {
  ...
  public static void main(String[] args) {
    int[][] nums = {
      {3, 5, 2, 6}, {2, 4, 3, 3, 5, 4, 9, 6}, {71, 18, 52, 29, 55, 73, 24, 42, 66, 8, 80, 2}
    };
    int[] k = {2, 4, 3};
    int[][] outputs = {{2, 6}, {2, 3, 3, 4}, {8, 80, 2}};
    FindTheMostCompetitiveSubsequence competitiveSubsequence =
        new FindTheMostCompetitiveSubsequence();
  ...
  private void helper(
      int[] comb, int start, int index, int[][] ans, int[] nums, boolean[] flowFromBack) {

...
public class CreateSortedArrayThroughInstructions {
  ...
  public static void main(String[] args) {
    ...
    CreateSortedArrayThroughInstructions createSortedArrayThroughInstructions =
        new CreateSortedArrayThroughInstructions();
    IntStream.range(0, inputs.length)
        .forEachOrdered(
            i -> {
              ...
              System.out.println(
                  "output " + output + " time " + (System.currentTimeMillis() - startTime) + " ms");
  ...
  private static final class Node extends BinaryTreeNode<Integer> {
    ...
    public String toString() {
      return "Node{ val=" + val + ", smallCount=" + smallCount + ", count=" + count + '}';
    }
  }
}

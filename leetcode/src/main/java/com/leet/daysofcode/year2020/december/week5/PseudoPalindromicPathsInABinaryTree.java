...
public class PseudoPalindromicPathsInABinaryTree {
  ...
  public static void main(String[] args) {
    TreeNode[] inputs = {
      TreeUtils.createTreeFromBfsArray(2, 3, 1, 3, 1, null, 1),
      TreeUtils.createTreeFromBfsArray(2, 1, 1, 1, 3, null, null, null, null, null, 1),
      TreeUtils.createTreeFromBfsArray(1)
    };
    int[] outputs = {2, 1, 1};
    PseudoPalindromicPathsInABinaryTree pseudoPalindromicPathsInABinaryTree =

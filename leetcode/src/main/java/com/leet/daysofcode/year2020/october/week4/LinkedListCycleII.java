...
public class LinkedListCycleII {
  ...
  public static void main(String[] args) {
    ListNode[] inputs = {
      LinkedListUtils.createCyclicList(1, 3, 2, 0, -4),
      LinkedListUtils.createCyclicList(0, 1, 2),
      LinkedListUtils.createCyclicList(-1, 1)
    };
    ListNode[] outputs = {
      LinkedListUtils.get(inputs[0], 1), LinkedListUtils.get(inputs[1], 0), null
    };

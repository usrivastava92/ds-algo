...
public class RecoverBinarySearchTree {
  ...
  public static void main(String[] args) {
    TreeNode[] inputs = {
      TreeUtils.createTreeFromBfsArray(1, 3, null, null, 2),
      TreeUtils.createTreeFromBfsArray(3, 1, 4, null, null, 2)
    };
    TreeNode[] outputs = {
      TreeUtils.createTreeFromBfsArray(3, 1, null, null, 2),
      TreeUtils.createTreeFromBfsArray(2, 1, 4, null, null, 3)
    };

package com.leet.daysofcode.year2020.october.week2;
...
public class SortList {
  ...
  public static void main(String[] args) {
    ListNode[] inputs = {
      LinkedListUtils.createList(4, 2, 1, 3), LinkedListUtils.createList(-1, 5, 3, 4, 0), null
    };
    ...
    IntStream.range(0, inputs.length)
        .forEachOrdered(
            i -> {
              ...
              System.out.println(
                  "output : " + LinkedListUtils.getTraversalAsList(sortList.sortList(inputs[i])));

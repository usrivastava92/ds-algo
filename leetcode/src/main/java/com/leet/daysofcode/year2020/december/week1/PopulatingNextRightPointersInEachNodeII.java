...
public class PopulatingNextRightPointersInEachNodeII {
  ...
  public static void main(String[] args) {
    PopulatingNextRightPointersInEachNodeII populatingNextRightPointersInEachNodeII =
    ...
    IntStream.range(0, 10)
        .forEachOrdered(
            i -> {
              ...
              Assert.assertEquals(
                  populatingNextRightPointersInEachNodeII.connectBfs(convert(input)),
                  populatingNextRightPointersInEachNodeII.connect(convert(input)));
            });
  }

...
public class SubtreeOfAnotherTree {
  ...
  public static void main(String[] args) {
    TreeNode[] s = {
      TreeUtils.createTreeFromBfsArray(3, 4, 5, 1, 2),
      TreeUtils.createTreeFromBfsArray(3, 4, 5, 1, 2, null, null, null, null, 0),
      TreeUtils.createTreeFromBfsArray(1, 2, 3)
    };
    TreeNode[] t = {
      TreeUtils.createTreeFromBfsArray(4, 1, 2),
      TreeUtils.createTreeFromBfsArray(4, 1, 2),
      TreeUtils.createTreeFromBfsArray(1, 2)
    };

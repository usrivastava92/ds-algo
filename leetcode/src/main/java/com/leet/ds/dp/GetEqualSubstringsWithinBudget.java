...
public class GetEqualSubstringsWithinBudget {
  ...
  public static void main(String[] args) {
    ...
    GetEqualSubstringsWithinBudget getEqualSubstringsWithinBudget =
        new GetEqualSubstringsWithinBudget();
    System.out.println(
        getEqualSubstringsWithinBudget.equalSubstring(
            s[testCaseIndex], t[testCaseIndex], maxCost[testCaseIndex]));
  }

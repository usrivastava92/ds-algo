...
public class PairsOfSongsWithTotalDurationsDivisibleBy60 {
  ...
  public static void main(String[] args) {
    PairsOfSongsWithTotalDurationsDivisibleBy60 pairsOfSongsWithTotalDurationsDivisibleBy60 =
        new PairsOfSongsWithTotalDurationsDivisibleBy60();
    System.out.println(
        pairsOfSongsWithTotalDurationsDivisibleBy60.numPairsDivisibleBy60(new int[] {60, 60, 60}));
  }

...
public class MinimizeTheAbsoluteDifferenceTest {
  ...
  public MinimizeTheAbsoluteDifferenceTest(
      List<Integer> a, List<Integer> b, List<Integer> c, int expected) {
    this.a = a;
    this.b = b;
    this.c = c;
  ...
  public void solve_returnsMinimumPossibleSpread() {
    ...
    assertEquals(
        expected, solution.solve(new ArrayList<>(a), new ArrayList<>(b), new ArrayList<>(c)));
  }
}

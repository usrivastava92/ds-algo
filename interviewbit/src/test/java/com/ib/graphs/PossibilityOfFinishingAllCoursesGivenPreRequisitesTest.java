...
public class PossibilityOfFinishingAllCoursesGivenPreRequisitesTest {
  ...
  public PossibilityOfFinishingAllCoursesGivenPreRequisitesTest(
      int courses, int[] prereqFrom, int[] prereqTo, int expected) {
  ...
  public void solve_returnsWhetherAllCoursesCanBeFinished() {
    PossibilityOfFinishingAllCoursesGivenPreRequisites solution =
        new PossibilityOfFinishingAllCoursesGivenPreRequisites();

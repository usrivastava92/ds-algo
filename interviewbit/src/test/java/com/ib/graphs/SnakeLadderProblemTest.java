...
public class SnakeLadderProblemTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {new int[][]{{32, 62}, {42, 68}, {12, 98}}, new int[][]{{95, 13}, {97, 25}, {93, 37}, {79, 27}, {75, 19}, {49, 47}, {67, 17}}, 3},
                {new int[][]{{8, 52}, {6, 80}, {26, 42}, {2, 72}}, new int[][]{{51, 19}, {39, 11}, {37, 29}, {81, 3}, {59, 5}, {79, 23}, {53, 7}, {43, 33}, {77, 21}}, 5},

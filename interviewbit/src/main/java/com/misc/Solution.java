...
public class Solution {
   ...
   */
  static int calculateDonation(
      PriorityQueue<PriorityQueue<Integer>> gener,
      PriorityQueue<PriorityQueue<Integer>> charm,
      int k) {
  ...
  public static void main(String[] args) {
    ...
    for (int tcItr = 0; tcItr < tc; tcItr++) {
      ...
      for (int tItr = 0; tItr < t; tItr++) {
        ...
        PriorityQueue<Integer> q = new PriorityQueue<>(Collections.reverseOrder());
        for (int generositiesItr = 1;
            generositiesItr < generositiesItems.length;
            generositiesItr++) {

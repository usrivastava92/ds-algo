...
public class SortBinaryLinkedList {
  ...
  public static void main(String[] args) {
    ListNode[] As = {
      LinkedListUtils.generateLinkedList(1, 0, 0, 1),
      LinkedListUtils.generateLinkedList(0, 0, 1, 1, 0)
    };
    ListNode[] outputs = {
      LinkedListUtils.generateLinkedList(0, 0, 1, 1),
      LinkedListUtils.generateLinkedList(0, 0, 0, 1, 1)
    };

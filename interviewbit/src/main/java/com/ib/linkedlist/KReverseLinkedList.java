...
public class KReverseLinkedList {
  ...
  public static void main(String[] args) {
    ListNode[] As = {
      LinkedListUtils.generateLinkedList(1, 2, 3, 4, 5, 6, 7, 8, 9, 0),
      LinkedListUtils.generateLinkedList(1, 2, 3, 4, 5, 6, 7, 8, 9, 0)
    };
    int[] Bs = {2, 5};
    ListNode[] outputs = {
      LinkedListUtils.generateLinkedList(2, 1, 4, 3, 6, 5, 8, 7, 0, 9),
      LinkedListUtils.generateLinkedList(5, 4, 3, 2, 1, 0, 9, 8, 7, 6)
    };

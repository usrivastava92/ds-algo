...
public class PalindromeList {
  ...
  public static void main(String[] args) {
    ListNode[] As = {
      LinkedListUtils.generateLinkedList(1, 1),
      LinkedListUtils.generateLinkedList(1, 2, 1),
      LinkedListUtils.generateLinkedList(1, 2, 2, 1),
      LinkedListUtils.generateLinkedList(1, 2, 3, 2, 1),
      LinkedListUtils.generateLinkedList(1, 5, 3, 2, 1)
    };

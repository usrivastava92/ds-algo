...
public class EvenReverse {
  ...
  public static void main(String[] args) {
    ListNode[] As = {
      LinkedListUtils.generateLinkedList(1, 2, 3, 4), LinkedListUtils.generateLinkedList(1, 2, 3)
    };
    ListNode[] outputs = {
      LinkedListUtils.generateLinkedList(1, 4, 3, 2), LinkedListUtils.generateLinkedList(1, 2, 3)
    };

...
public class CryptoService {
  ...
  private static void setCryptographyObject(Object value, final CryptoType cryptoType)
      throws Exception {
  ...
  private static void encryptionDecryptionAttribute(
      Field field, Object value, CryptoType cryptoType) throws Exception {
    ...
    try {
      if (field != null && obj != null) {
        ...
        if (StringUtils.isNotBlank(fieldValue)) {
          ...
          if (!StringUtils.isEmpty(fieldValue)) field.set(obj, UNIQUECRYPTO + fieldValue);
        }
      }
    } catch (Exception e) {
